...
# REDIS_HOST_RUN1 = "10.214.147.123"
REDIS_HOST_RUN2 = "10.210.219.179"
...
create_job(REDIS_HOST_RUN2, 2)
    ...
    #     # command_kube2 = f"gcloud container clusters get-credentials config-20-10-10-run2-cluster"
    #     # subprocess.check_call(command_kube2, shell=True)
    #     processing_length2, pending_length2 = get_redis_status(REDIS_HOST_RUN2, PROCESSING_QUEUE, PENDING_QUEUE)
    #     if processing_length2 == 0 and pending_length2 == 0:
    ...
    #     else:
    #         print(
    #             f'processing_length1 = {processing_length2}, pending_length1= {pending_length2}. Sleeping for 5sec')
    #         time.sleep(5)

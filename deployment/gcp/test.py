...
while PROCESSED_ELEMS <= MAX_ELEMS:
    ...
    while True:
        ...
        if processing_length1 == 0 and pending_length1 == 0:
            print('it seems redis queue is cleared. sleeping for 60sec before deleting job')
            time.sleep(60)
            delete_job()
            ...
            print(
                f'processing_length1 = {processing_length1}, pending_length1= {pending_length1}. '
                f'processing_length2 = {processing_length2}, pending_length2= {pending_length2} Sleeping for 5sec')
            time.sleep(5)
